...
// #define L 524288 // 512 768 2048 6144 65536 98304 262144 524288
// #define F 1048576
// #define C 4 // 4 8 20 40
...
int main(int argc, char ** argv)
{
    ...
    // Generar el acceso aleatorio. Este array contendrá los valores para acceder aleatoriamente.

    int * used = (int *) malloc(sizeof(int) * F);
    for (int i = 0; i < F; i++) used[i] = 0;

    int * ind = (int *) malloc(sizeof(int) * F);
    for (int i = 0; i < F; i++) {
        int start = rand() % F;
        while (used[start]) {
            start = (start + 1) % F;
